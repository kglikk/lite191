...
let DeleteProjectFormComponent = class DeleteProjectFormComponent {
    ...
    deleteProject() {
        if (confirm('Are you sure ?')) {
            ...
            // this.selectedProject = this.projects.find(p => p.id == this.deletedProject.project)
            // console.log("Selected Project ", this.selectedProject);
            //selectedProjectId = this.selectedProject.id;
            //this.projectService.changeProjectName("Project not opened");
            //this.projectService.changeProjectId(this.selectedProject.id);s
